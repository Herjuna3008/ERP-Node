const lang = {
  ...
  global_discount_type: 'Global Discount Type',
  global_discount_value: 'Global Discount Value',
  amount: 'Amount',
  reference: 'Reference',
  ...
  no_price_history: 'No pricing history available',
  type: 'Type',
  unit: 'Unit',
  none: 'None',
  ...
  add_new_stock_entry: 'Add New Stock Entry',
  entry_type: 'Entry Type',
  cost_price: 'Cost Price',
  sell_price: 'Sell Price',
  source_type: 'Source Type',
  source_id: 'Source ID',
  stock_to_buy: 'Stock To Buy',
  draft: 'Draft',
  sent: 'Sent',
  confirmed: 'Confirmed',
  paid: 'Paid',
  ...
  recap_report_description: 'Export an overview of sales, purchases, and expenses for a selected period.',
